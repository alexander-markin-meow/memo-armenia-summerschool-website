...
const COLLECTION_SEED_KEY = 'lori-collection-seed';
const COLLECTION_SCROLL_KEY = 'lori-collection-scroll';
...
function remove(storage: StorageLike | null, key: string) {
  try {
    ...
    // Storage may be disabled. There is nothing else to clean up.
  }
}
